...
public class AdoptionOrphanageChildrenListAdapter extends FirestoreRecyclerAdapter<ChildModel, AdoptionOrphanageChildrenListAdapter.OrphanageChildrenViewHolder> {
    ...
    public AdoptionOrphanageChildrenListAdapter(OnDocumentCheckListener onDocumentCheckListener, OnListItemClickListener onListItemClickListener, @NonNull FirestoreRecyclerOptions<ChildModel> options) {
        super(options);
    ...
    public class OrphanageChildrenViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            onListItemClickListener.onListItemClick(getAbsoluteAdapterPosition());
        }
