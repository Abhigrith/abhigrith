...
public class AdoptionOrphanageListAdapter extends FirestoreRecyclerAdapter<OrphanageModel, AdoptionOrphanageListAdapter.OrphanageViewHolder> {
    ...
    public AdoptionOrphanageListAdapter(OnListItemClickListener onListItemClickListener, OnDocumentCheckListener onDocumentCheckListener, @NonNull FirestoreRecyclerOptions<OrphanageModel> options) {
        super(options);
